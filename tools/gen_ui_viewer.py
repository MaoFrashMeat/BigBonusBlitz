...
<div class="wrap">
  <div class="row">
    ...
    <label>倍率 <input type="range" id="zoom" min="0.6" max="1.6" step="0.1" value="1"><span id="zoomV">1.0</span></label>
  </div>
...
document.getElementById('zoom').oninput = e => { const z = parseFloat(e.target.value); document.getElementById('zoomV').textContent = z.toFixed(1); const p = document.getElementById('phone'); p.style.transform = `scale(${z})`; p.style.transformOrigin = '50% 0'; p.style.marginBottom = (540 * (z - 1)) + 'px'; };
