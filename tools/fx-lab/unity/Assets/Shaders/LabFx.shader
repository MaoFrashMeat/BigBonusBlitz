...
Shader "Lab/FxAdd"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D _MainTex; float4 _MainTex_ST; float _Intensity; float _LabEmit;
            ...
            float4 frag(v2f i):SV_Target
            {
                ...
                float a = t.a * i.col.a;
                return float4(t.rgb * i.col.rgb * _Intensity * a * _LabEmit, 0);
            }
            ENDCG
        }
    }
