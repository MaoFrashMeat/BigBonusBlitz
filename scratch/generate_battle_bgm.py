...
def generate_square_wave(frequency, duration, volume=0.3, duty_cycle=0.5):
    ...
    for i in range(num_samples):
        env = 1.0
        if i < 0.02 * SAMPLE_RATE:
            env = i / (0.02 * SAMPLE_RATE)
...
def generate_triangle_wave(frequency, duration, volume=0.4):
    ...
    for i in range(num_samples):
        ...
        if i < 0.02 * SAMPLE_RATE:
            env = i / (0.02 * SAMPLE_RATE)
        elif i > num_samples - 0.02 * SAMPLE_RATE:
            env = (num_samples - i) / (0.02 * SAMPLE_RATE)
...
melody = [
    ('A4', EIGHTH), ('A5', EIGHTH), ('E5', EIGHTH), ('A5', EIGHTH),
    ('C5', EIGHTH), ('B4', EIGHTH), ('G4', EIGHTH), ('B4', EIGHTH),
    ('F4', EIGHTH), ('F5', EIGHTH), ('C5', EIGHTH), ('F5', EIGHTH),
    ('E5', EIGHTH), ('D5', EIGHTH), ('C5', EIGHTH), ('B4', EIGHTH),
    
    ('A4', EIGHTH), ('A5', EIGHTH), ('E5', EIGHTH), ('A5', EIGHTH),
    ('C5', EIGHTH), ('B4', EIGHTH), ('G4', EIGHTH), ('B4', EIGHTH),
    ('F5', EIGHTH), ('E5', EIGHTH), ('D5', EIGHTH), ('C5', EIGHTH),
    ('B4', EIGHTH), ('C5', EIGHTH), ('D5', EIGHTH), ('E5', EIGHTH),
]

bass = [
    ('A2', EIGHTH), ('A2', EIGHTH), ('A2', EIGHTH), ('A2', EIGHTH),
    ('G2', EIGHTH), ('G2', EIGHTH), ('G2', EIGHTH), ('G2', EIGHTH),
    ('F2', EIGHTH), ('F2', EIGHTH), ('F2', EIGHTH), ('F2', EIGHTH),
    ('E2', EIGHTH), ('E2', EIGHTH), ('E2', EIGHTH), ('E2', EIGHTH),
...
melody_track = []
for n, d in melody * 4: 
    melody_track.extend(generate_square_wave(notes[n], d, volume=0.15, duty_cycle=0.5))
...
with wave.open('assets/bgm/bgm_battle.wav', 'w') as wf:
    wf.setnchannels(1)
    wf.setsampwidth(2)
...
print("Battle BGM generated successfully")
